...
\tightlist
\item
  \textbf{Residuos ordinarios:} \(\hat{\varepsilon}_i = Y_i - \hat{Y}_i\)
\item
  \textbf{Residuos estandarizados:} \(\frac{\hat{\varepsilon}_i}{\hat{\sigma}}\)
\item
  \textbf{Residuos estudentizados:} \(\frac{\hat{\varepsilon}_i}{\hat{\sigma}_i\sqrt{1-h_{ii}}}\)
\end{enumerate}
...
\tightlist
\item
  \textbf{AIC:} \(AIC = n \ln(\hat{\sigma}^2) + 2k\)
\item
  \textbf{BIC:} \(BIC = n \ln(\hat{\sigma}^2) + k \ln(n)\)
\end{itemize}
...
\tightlist
\item
  \textbf{Ridge:} \(\min_{\beta} \|Y - X\beta\|_2^2 + \lambda \|\beta\|_2^2\)
\item
  \textbf{LASSO:} \(\min_{\beta} \|Y - X\beta\|_2^2 + \lambda \|\beta\|_1\)
\item
